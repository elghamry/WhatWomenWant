...
Intent search = new Intent(VoiceRecognitionActivity.this, SearchViewActivity.class);
        search.putExtra("result",matches.get(0)+getIntent().getStringExtra("filter"));
